...
import { IonSegmentButton, IonSegment, IonLabel, IonContent, IonFabButton, IonFab, IonIcon,
  IonAvatar, IonPopover, IonHeader, IonToolbar, IonButtons, IonTitle, IonMenuButton, IonMenu, IonButton } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonButton, IonTitle, IonButtons, IonToolbar, IonHeader, IonPopover, IonAvatar, IonIcon, IonFab, IonFabButton,
    IonContent, IonLabel, IonSegment, IonSegmentButton, CommonModule, FormsModule, IonMenuButton,
    StateModule, CategoriesModule, IonMenu, SidemenuComponent]
})
